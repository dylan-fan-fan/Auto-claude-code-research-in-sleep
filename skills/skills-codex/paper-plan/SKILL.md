...
spawn_agent:
  ...
  message: |
    ...
    8. First-use accessibility — does the plan expand every technical abbreviation before first use in the Abstract and again in the main text, with self-contained captions?
